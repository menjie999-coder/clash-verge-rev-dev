...
export const translationKeys = [
  ...
  'proxies.page.actions.recheck',
  'proxies.page.actions.recover',
  ...
  'proxies.page.chain.inChain',
  'proxies.page.chain.health.healthy',
  'proxies.page.chain.health.drifted',
  'proxies.page.chain.health.unhealthy',
  'proxies.page.chain.health.idle',
  'proxies.page.chain.health.driftedHint',
  'proxies.page.chain.health.unhealthyHint',
  'proxies.page.chain.presets.empty',
  'proxies.page.chain.presets.placeholder',
  'proxies.page.chain.presets.group.smart',
  'proxies.page.chain.presets.group.manual',
  'proxies.page.chain.presets.actions.oneClick',
  'proxies.page.chain.presets.actions.applyOnly',
  'proxies.page.chain.presets.actions.applyAndConnect',
  'proxies.page.chain.presets.actions.saveCurrent',
  'proxies.page.chain.presets.actions.manage',
  'proxies.page.chain.presets.matchType.exact',
  'proxies.page.chain.presets.matchType.keyword',
  'proxies.page.chain.presets.feedback.saved',
  'proxies.page.chain.presets.feedback.connected',
  'proxies.page.chain.presets.feedback.missingNodes',
  'proxies.page.chain.presets.feedback.noTargetGroup',
  'proxies.page.chain.presets.feedback.emptyName',
  'proxies.page.chain.presets.dialogs.saveTitle',
  'proxies.page.chain.presets.dialogs.saveTitleSmart',
  'proxies.page.chain.presets.dialogs.saveTitleManual',
  'proxies.page.chain.presets.dialogs.nameLabel',
  'proxies.page.chain.presets.dialogs.savePreview',
  'proxies.page.chain.presets.dialogs.keywordPreview',
  'proxies.page.chain.presets.dialogs.noKeyword',
  'proxies.page.chain.presets.dialogs.manageTitle',
  'proxies.page.chain.presets.dialogs.manageMeta',
  'proxies.page.chain.presets.dialogs.fallbackTitle',
  'proxies.page.chain.presets.dialogs.fallbackHint',
  'proxies.page.chain.smart.tab',
  'proxies.page.chain.smart.advancedTab',
  'proxies.page.chain.smart.addRegion',
  'proxies.page.chain.smart.regionHealthy',
  'proxies.page.chain.smart.regionBest',
  'proxies.page.chain.smart.noHealthyNode',
  'proxies.page.chain.smart.currentNode',
  'proxies.page.chain.smart.templates',
  'proxies.page.chain.smart.connect',
  'proxies.page.chain.smart.disconnect',
  'proxies.page.chain.smart.duplicateRegion',
  'proxies.page.chain.smart.duplicateNode',
  'proxies.page.chain.smart.pinnedExit',
  'proxies.page.chain.smart.pinExit',
  'proxies.page.chain.smart.pinExitNode',
  'proxies.page.chain.smart.pinExitNodeHint',
  'proxies.page.chain.smart.allDownHint',
  'proxies.page.chain.smart.allDownNotice',
  'proxies.page.chain.smart.anomalyTitle',
  'proxies.page.chain.smart.switchConfirmTitle',
  'proxies.page.chain.smart.switchConfirmFromManual',
  'proxies.page.chain.smart.switchConfirmFromSmart',
  'proxies.page.chain.smart.switchConfirmOk',
  'proxies.page.chain.smart.refreshHealth',
  'proxies.page.chain.smart.presetApply',
  'proxies.page.chain.smart.presetApplyShort',
  'proxies.page.chain.smart.presetApplyConnect',
  'proxies.page.chain.smart.presetApplyConnectShort',
  'proxies.page.chain.smart.presetRegionHop',
  'proxies.page.chain.smart.presetFilterHop',
  'proxies.page.chain.smart.live.online',
  'proxies.page.chain.smart.live.offline',
  'proxies.page.chain.smart.live.checking',
  'proxies.page.chain.smart.live.idle',
  'proxies.page.chain.smart.wizard.title',
  'proxies.page.chain.smart.wizard.frontRegion',
  'proxies.page.chain.smart.wizard.exitNode',
  'proxies.page.chain.smart.wizard.connect',
  'proxies.page.chain.smart.wizard.advancedHint',
  'proxies.page.chain.smart.hint.needHops',
  'proxies.page.chain.smart.hint.needGroup',
  'proxies.page.chain.smart.hint.deadHop',
  'proxies.page.chain.smart.hint.ready',
  'proxies.page.chain.smart.status.healthy',
  'proxies.page.chain.smart.status.degraded',
  'proxies.page.chain.smart.status.down',
